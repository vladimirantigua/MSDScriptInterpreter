...
#include "../expr.h"
#include "../step.h"
#include "../pointer.h"//moving #includes to the correct directory by adding ../
...
//    std::string command = "--interp";
//    // cast the string
//    char* command_pointer = (char*) command.data();
//    char* expr_p = (char*) expr.data();
//
//    char* expr_array[] = {NULL, command_pointer, expr_p};
...
//Add the following command line to the which_day.cpp:
